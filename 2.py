...
x, y, w, h = 100, 200, 1600, 900  # Adjust these values based on your specific region of interest
    ...
    with xpc.XPlaneConnect() as client:
        while True:
            ...
            if len(edge_coordinates) >= 2:
                ...
                pitch = client.getPOSI()[3]  # Assuming pitch is the 4th value in the returned list
